function showTime() { 
	...
	var startDate = new Date(2015, 04, 06);
	...
	if (seconds < 10) 
	seconds = "0" + seconds; 
	var currentTimeString = "Dear HanPing:<br>"
		...
		+	"<c style=\"color: #CCCCCC; text-shadow:2px 3px 3px #222; font-family:Microsoft YaHei; font-size:20px\" >----LiuZhenShuai   2015-04-06</c>"; 
